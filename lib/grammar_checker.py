...
class GrammarChecker:
    def __init__(self, device: torch.device, model_path="./models/prithivida_grammar_error_correcter_v1"):
...
if __name__ == "__main__":
    ...
    grammar_checker = GrammarChecker(device, model_path="./models/prithivida_grammar_error_correcter_v1_fp16")
