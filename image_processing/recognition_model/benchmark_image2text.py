...
from ai_part.recognition_model.utils import get_free_gpu_memory
...
def run_image2text_recognition_with_monitoring(image_dir, model_name, batch_size, memory_queue, device):
...
def benchmark(test_file, source_image_dir, model_name, output_file, temp_image_dir, batch_sizes, device):
    results_summary = []
    ...
    for batch_size in batch_sizes:
        ...
        generated_texts, gpu_memory_log = run_image2text_recognition_with_monitoring(temp_image_dir, model_name, batch_size, memory_queue, device)
...
if __name__ == "__main__":
    ...
    benchmark(args.test_file, args.source_image_dir, args.model_name, args.output_file, args.temp_image_dir, args.batch_sizes)
